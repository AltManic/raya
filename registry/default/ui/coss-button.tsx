/*
 * COSS-aligned port of coss ui's `registry/default/ui/button.tsx` @ e937bec (MIT surface).
 * Only the Spinner import differs from coss (raya names the item `coss-spinner`).
 */
"use client";
