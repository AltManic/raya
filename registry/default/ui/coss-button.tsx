/*
 * PROTOTYPE (#25) — port of coss ui's `registry/default/ui/button.tsx` @ e937bec (MIT surface).
 * Only the Spinner import differs from coss (raya names the item `coss-spinner` in this prototype).
 */
"use client";
...
import { Spinner } from "@/registry/default/ui/coss-spinner";
